...
async function loadData() {
    try {
        ...
        data.results.forEach((result) => {
            ...
            const descriptionA = result.description;
            ...
            cart.innerHTML = `
            <div class="cart font-['Roboto'] group relative h-[386px] w-[288px] rounded-[20px] text-center overflow-hidden md:h-[300px] w-[20px] m-5 lg:w-[288px] h-[386px]">
            ...
            <div class="" onclick="add()"><i class="like fa-solid fa-heart"></i></div>
            </div>
            </div>
            `;
...
function search(title) {
    const search = document.querySelector("#input").valus;
    console.log(search)
